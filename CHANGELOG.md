...
## [25.158.2](https://github.com/DNUM-SocialGouv/emjpm/compare/v25.158.1...v25.158.2) (2024-03-06)
...
* **p5-export:** stream from database to sftp server ([#2898](https://github.com/SocialGouv/emjpm/issues/2898)) ([b76c9da](https://github.com/SocialGouv/emjpm/commit/b76c9da84079c92bc2700736d66382b67a9ce3bc))
...
* **p5-timeout:** change timeout for p5 export ([#2895](https://github.com/SocialGouv/emjpm/issues/2895)) ([2b28ad7](https://github.com/SocialGouv/emjpm/commit/2b28ad75546b45aa0400447546fdc9505247ddf9))
...
* **display-siret:** fix displayed siret for mandataire ([#2888](https://github.com/SocialGouv/emjpm/issues/2888)) ([407b4fb](https://github.com/SocialGouv/emjpm/commit/407b4fb432cad2d64c5046c061173483bfe4e63e))
...
* upgrade erm ([908d1da](https://github.com/SocialGouv/emjpm/commit/908d1da7cea4f6a903993b541d89dad8f8b02f3f))
...
* **api:** mandoline directions ([80f3ed5](https://github.com/SocialGouv/emjpm/commit/80f3ed5ab5705f07d2a3eb010e64cca61d3c0126))
...
* **ti:** allow to delete magistrat fix [#2816](https://github.com/SocialGouv/emjpm/issues/2816) ([d24d11c](https://github.com/SocialGouv/emjpm/commit/d24d11c23740281b305f680cb08fd207bb40ac31))
...
* **email-about-mesure:** mailto ([0ece3a2](https://github.com/SocialGouv/emjpm/commit/0ece3a28e6562b13606337b55f66f37d1bcb66a4))
...
* **clean:** remove old code ([13e1af0](https://github.com/SocialGouv/emjpm/commit/13e1af0ab122123dd298a92a67a7cb22f4922eb0))
* **import-file:** timeout up to 15 minutes ([e7c321c](https://github.com/SocialGouv/emjpm/commit/e7c321cf08e80d684654e82830b319ee242c414f))
...
* **mesures:** departements filter missing mesures ([9f31113](https://github.com/SocialGouv/emjpm/commit/9f311139034c366753a94d46f853364913cfe026))
...
* **mesures-count:** nullable columns ([9e794e3](https://github.com/SocialGouv/emjpm/commit/9e794e32010d2377e34b4be8237ea96052d82516))
...
* **inscription:** fix anon rights on view + query ([c673bff](https://github.com/SocialGouv/emjpm/commit/c673bff3adb3709e86ad87615a13c1a7b8831e0a))
...
* **stats:** view indicators service multi deps ([84398b3](https://github.com/SocialGouv/emjpm/commit/84398b39e0087a58088a80f4dc58ab4d91b47082))
...
* **sdep:** fix edit service ([863c3c0](https://github.com/SocialGouv/emjpm/commit/863c3c0940f49ba152f62a0c5f638dfe72097ad7))
...
* **label:** tribunaux préferentiels ([fce6b4e](https://github.com/SocialGouv/emjpm/commit/fce6b4e2574d489d712f7efee61e35a7e381eb3c))
* **lb-ti:** service always have habilitation ([6e5eeb2](https://github.com/SocialGouv/emjpm/commit/6e5eeb276f56e883c675539e7e04ba90aa912b91))
...
* **cache:** magistrat delete mesure ([843d9f8](https://github.com/SocialGouv/emjpm/commit/843d9f84891d2e48d2974a796be8a82191ac75f4))
* **null-links:** tis ([9de7a92](https://github.com/SocialGouv/emjpm/commit/9de7a92e85c2a6115d6ff9c69db1c2017a52fa2b))
...
* **hasura:** v3 data sources ([c838097](https://github.com/SocialGouv/emjpm/commit/c83809704e647d6fec75cb6ee8278cb5aa4a942a))
...
* **schema:** add indexes ([2ea5381](https://github.com/SocialGouv/emjpm/commit/2ea53816c3ca14e16ba2d6bdd8c026fa911b288a))
* **schema:** clean indexes ([b014c8a](https://github.com/SocialGouv/emjpm/commit/b014c8a4e7321acc79d8bf16198be89187a348ac))
...
* **uid:** rely uid on user type ([430dd7c](https://github.com/SocialGouv/emjpm/commit/430dd7cfdab91133634bb5337124859b073acf87))
...
* **parseint:** gestionnaire id ([15c053a](https://github.com/SocialGouv/emjpm/commit/15c053a1569fffcdee38b71b9cd8fe9f99ba7b67))
...
* **mesure-edit:** prestation-sociales ([87ed13c](https://github.com/SocialGouv/emjpm/commit/87ed13cda82688ca88ceb973dbe27fb99794dcc3))
...
* **ocmi-sync:** cron hour to 5 ([09825e1](https://github.com/SocialGouv/emjpm/commit/09825e1cee3e06cce7b840146f7fc2e0b516a77e))
...
* **lb:** link id ([d547156](https://github.com/SocialGouv/emjpm/commit/d547156da4ddcbfd2a82f5b0e538000a091fee08))
...
* **lb:** inner join ([46d660f](https://github.com/SocialGouv/emjpm/commit/46d660f074a7d61122ed05dfb1bda42a9245ba6a))
...
* **stats:** departement filter right target ([9bad099](https://github.com/SocialGouv/emjpm/commit/9bad099f68f29769fce382975a9f7228418f97af))
...
* **perms:** ti on api oauth ([2fac536](https://github.com/SocialGouv/emjpm/commit/2fac5362b8cecf2ab263839887f52d8d76d7a024))
...
* **migration:** enquete clean before restructure db ([7b5b629](https://github.com/SocialGouv/emjpm/commit/7b5b629b9df41f273b1560a9b093081b3737285f))
* **perms:** editor_by_pk ti ([3fe0c9d](https://github.com/SocialGouv/emjpm/commit/3fe0c9d592af8c317821bbefdfe9d65fbcbc4e97))
...
* **stats:** view_users_stats for anonymous perms ([a762cb6](https://github.com/SocialGouv/emjpm/commit/a762cb6ef25ed706b6efb70216e00999f1cef475))
...
* **dev:** stash on ci scripts ([ae6ee29](https://github.com/SocialGouv/emjpm/commit/ae6ee29618670ddd4a31469c8d2fcae6eb2414fc))
...
* **filter:** ref change (was breaking some paginations) ([efda94c](https://github.com/SocialGouv/emjpm/commit/efda94cc5b30e1808610bc036d935e557912ae30))
...
* **jsx:** missing container import ([9677588](https://github.com/SocialGouv/emjpm/commit/9677588ed127cffdae7393c3190cedce7f615088))
...
* **dev:** script dev:yarn-refresh ([13938f5](https://github.com/SocialGouv/emjpm/commit/13938f597aac7782e9aa5e29e0e9ba4782e22e8c))
* **dev:** smtp dev env ([656f09c](https://github.com/SocialGouv/emjpm/commit/656f09c0da57f975ab9fc613865d2589a3adcfa0))
...
* **dev:** clean ([da90b42](https://github.com/SocialGouv/emjpm/commit/da90b42894d90fb699f8904f0aa4b9fab1f7c7c7))
...
* **direction:** empty list ([55e0fba](https://github.com/SocialGouv/emjpm/commit/55e0fbaa704a4f53cf895d40625f86e1c249c692))
...
* **filter-dpt:** etablissements ([3418296](https://github.com/SocialGouv/emjpm/commit/3418296b7b329a02b934a3193f05c84ea51965bf))
...
* **refacto-dpt:** error on create service ([04b0062](https://github.com/SocialGouv/emjpm/commit/04b00625d4dc707ec95638bd54408d8099025a45))
...
* **mesure-editor-id:** hasura migration ([4599de9](https://github.com/SocialGouv/emjpm/commit/4599de9b79c8fafeced259a42484f757ee8dd9c4))
...
* **departement:** column ([a040185](https://github.com/SocialGouv/emjpm/commit/a040185abcd87a30d34adc40407e3ec4c2f4091c))
...
* **ci:** prod needs ([47ee4b9](https://github.com/SocialGouv/emjpm/commit/47ee4b96296a799b5fa6a16921d995dee2cf0c96))
...
* **ci:** pipeline cache ([1d5c83a](https://github.com/SocialGouv/emjpm/commit/1d5c83a8fe3d662647ab63ffcbe5e71f772e1db7))
...
* **dev:prod:** port ([46baac3](https://github.com/SocialGouv/emjpm/commit/46baac38f68369af92d62a2cf89455f8a4a0b396))
* **dev:prod:** script ([eb452de](https://github.com/SocialGouv/emjpm/commit/eb452de80e1480286bfee7029fcf77d8e9b6b77c))
...
* **api:** do not escape input string ([091ce14](https://github.com/SocialGouv/emjpm/commit/091ce1442bdbc95d223b61280d5ebd2737677a0d))
* **api:** return explicit error message if bad content type ([9ef6953](https://github.com/SocialGouv/emjpm/commit/9ef69531d0fef4ee7ceb9ac5a57b36b9a3fff457))
* **ci:** remove dependencies deletion on release job ([0e1d2ae](https://github.com/SocialGouv/emjpm/commit/0e1d2aec93ce323a2009dd4883997e8e04898682))
* **liste-blanche:** convert departement id to int ([96e70d6](https://github.com/SocialGouv/emjpm/commit/96e70d606c6569d1531dcb62c1048a73e20449cc))
* **liste-blanche:** display delete button in edit mode only ([d232f29](https://github.com/SocialGouv/emjpm/commit/d232f2980e919567e2588d819500a8522e0793f9))
...
* **access-token:** update hasura permission for direction ([660a047](https://github.com/SocialGouv/emjpm/commit/660a047dee2e792834057bbb02acf0f144fea5fb))
...
* **import-mesure:** update hasura permission ([37c1ee0](https://github.com/SocialGouv/emjpm/commit/37c1ee0ebd922d542dbd53d7894b6ab4b8f39a8d))
...
* **api:** install p7zip in container api ([#2305](https://github.com/SocialGouv/emjpm/issues/2305)) ([cf13c5a](https://github.com/SocialGouv/emjpm/commit/cf13c5a2c681be12059b84ce539bd73fee8ccfbf))
...
* **k8s:** pass request_uri in hostname redirection ([#2224](https://github.com/SocialGouv/emjpm/issues/2224)) ([ff5287b](https://github.com/SocialGouv/emjpm/commit/ff5287b8e0bbe324ff4f05c2d2bc33976a2d3dbe))
...
* **ci:** use prod2 ([#2209](https://github.com/SocialGouv/emjpm/issues/2209)) ([545e0df](https://github.com/SocialGouv/emjpm/commit/545e0dfb56d92c6a4498821ca47f47073bf05ec7))
...
* **lint:** prop-types ([#2023](https://github.com/SocialGouv/emjpm/issues/2023)) ([f8cab61](https://github.com/SocialGouv/emjpm/commit/f8cab61c1406937e1249317ea08497c4abdc58df))
...
* **hasura:** export metadata ([aa997cd](https://github.com/SocialGouv/emjpm/commit/aa997cdddc44c51872f107541028b432776d82f3))
...
* **enquete:** update hasura metadata ([#1942](https://github.com/SocialGouv/emjpm/issues/1942)) ([af3310f](https://github.com/SocialGouv/emjpm/commit/af3310f3953dc8b752985533fdfcd6b088610f4b))
...
* **hasura:** upgrade migration cli ([#1918](https://github.com/SocialGouv/emjpm/issues/1918)) ([641e6e5](https://github.com/SocialGouv/emjpm/commit/641e6e595a6d9e20a1d5e5d0165acac12c727298))
...
* **k8s:** missing secret ([#1813](https://github.com/SocialGouv/emjpm/issues/1813)) ([d55cb7a](https://github.com/SocialGouv/emjpm/commit/d55cb7a8508c80faeda2f7775684dcb4c52c190d))
...
* **renovate:** enable light mode [#1810](https://github.com/SocialGouv/emjpm/issues/1810) ([#1818](https://github.com/SocialGouv/emjpm/issues/1818)) ([409fbcf](https://github.com/SocialGouv/emjpm/commit/409fbcf5f72e598ec9d3ff7c4cc446edff8cd782))
...
* **hasura:** [#1726](https://github.com/SocialGouv/emjpm/issues/1726) migration hasura config v2 ([#1731](https://github.com/SocialGouv/emjpm/issues/1731)) ([7717335](https://github.com/SocialGouv/emjpm/commit/7717335660fe429ab6f4bd3c0eb0961c141b6525))
...
* **mesure:** refresh gestionaire data ([#1701](https://github.com/SocialGouv/emjpm/issues/1701)) ([747f72b](https://github.com/SocialGouv/emjpm/commit/747f72bbe6888e01d97c0781ca44e62bb2b23d86))
* **mesure:** visualize mesure ([#1698](https://github.com/SocialGouv/emjpm/issues/1698)) ([8900d52](https://github.com/SocialGouv/emjpm/commit/8900d52d1b8399544b8c63db43f87932c4f0edcf))
...
* **service-menu:** add import and members in menu ([58f690e](https://github.com/SocialGouv/emjpm/commit/58f690e581baf80fd65409b0c9bc157c4b939316))
...
* **service-antennes-metadata:** update metadata ([#1436](https://github.com/SocialGouv/emjpm/issues/1436)) ([ea5e3d7](https://github.com/SocialGouv/emjpm/commit/ea5e3d7a268860bb0e219a8f7d7f3830b6b1b7c3))
...
* **hasura-permission:** update view_gestionnaire_mesure permission ([f335401](https://github.com/SocialGouv/emjpm/commit/f33540117a9a97726d431ef8459112713f72c9bd))
...
* **metadata:** add missing metadata ([#1276](https://github.com/SocialGouv/emjpm/issues/1276)) ([e02da56](https://github.com/SocialGouv/emjpm/commit/e02da5663e3c9dcbd4024bd7ae7b2a881ec1a6fc))
...
* Revert "build(docker): tell hasura to use network host in dev (#1264)" ([b0c4b7f](https://github.com/SocialGouv/emjpm/commit/b0c4b7f5bf91499f779d2aaea5be3a1b6b4d921f)), closes [#1264](https://github.com/SocialGouv/emjpm/issues/1264)
...
* **deps:** update dependency lerna to ^3.19.0 ([#1225](https://github.com/SocialGouv/emjpm/issues/1225)) ([2e8f12d](https://github.com/SocialGouv/emjpm/commit/2e8f12d7db0931c6c89b530d394e5a6b066f7ea9))
...
* **mandataire-import:** handle date format with excel ([#1055](https://github.com/SocialGouv/emjpm/issues/1055)) ([8175ac6](https://github.com/SocialGouv/emjpm/commit/8175ac6))
* **service-permission:** update permission ([#1052](https://github.com/SocialGouv/emjpm/issues/1052)) ([34df37a](https://github.com/SocialGouv/emjpm/commit/34df37a))
...
* **wilcard-certificat:** handle wildcard certificate for dev env ([#1010](https://github.com/SocialGouv/emjpm/issues/1010)) ([4e9f675](https://github.com/SocialGouv/emjpm/commit/4e9f675))
...
* **hasura-permission:** update hasura permissions ([#946](https://github.com/SocialGouv/emjpm/issues/946)) ([76ae708](https://github.com/SocialGouv/emjpm/commit/76ae708))
...
* **signup:** add null test ([#929](https://github.com/SocialGouv/emjpm/issues/929)) ([0eeb065](https://github.com/SocialGouv/emjpm/commit/0eeb065))
* **signup:** restore old signup path ([#931](https://github.com/SocialGouv/emjpm/issues/931)) ([544acc2](https://github.com/SocialGouv/emjpm/commit/544acc2))
...
* **reservation-date:** use creation date as reservation date ([#921](https://github.com/SocialGouv/emjpm/issues/921)) ([eeb4a6f](https://github.com/SocialGouv/emjpm/commit/eeb4a6f))
